...
if(num1 > num2 && num1>num3 && num1 > num4 )//checking num1 is greater than num2 and num3
{
    printf("num1 is greatest\n");// display the result on console
}
if(num2 > num1 && num2>num3 && num2 > num4)//checking num2 is greater than num1 and num3
{
    printf("num2 is greatest\n");// display the result on console
}
if(num3 > num1 && num3>num2 && num3 > num4)//checking num3 is greater than num1 and num2
{
    printf("num3 is greatest\n");// display the result on console
}
if(num4 > num1 && num4 > num2 && num4 > num3)//checking num4 is greater than num1 and num2 and num3
{
